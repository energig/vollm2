...
<head>
	...
	<title>ENERGO Vertretungsvollmacht Privatkunden</title>
...
<body>
	<div id="page-wrap">
		...
		<div id="identity">
            ...
            <div id="formtitle">
				<h2>&nbsp;</h2>
				<h2>Vertretungsvollmacht/Auftrag</h2>
                <p>&nbsp;</p>
                ...
                <div class="section">
                    <table class="vmtable">
                        ...
                        <tr>
                            <td><strong>Geburtsdatum</strong></td><td class="uline"> {{ date('d.m.Y', strtotime($costumer->geburtsdatum)) }} </td>
                        </tr>
                        <tr>
		...
		<div class="section just margtop smalltext80">
            <p>&nbsp;</p>
            <p>
                die ENERGO Energiedienstleistungen GmbH (FN 482457x , kurz ENERGO ), Ragnitzstraße 14, 8047 Graz, in meinem/
            ...
            <p>
                Ich/Wir beauftrage /beauftragen ENERGO bis auf Widerruf für mich/uns die bestehenden Energielieferverträge für Strom und/oder Gas mit am Markt günstigen Anbietern zu vergleichen und gegebenenfalls bei einem günstigeren Preis pro kWh den/die
