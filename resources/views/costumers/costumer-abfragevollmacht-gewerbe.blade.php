...
<head>
	...
	<title>ENERGO Abfragevollmacht Gewerbekunden</title>
		...
		<div id="identity">
            ...
            <div id="formtitle">
                ...
                <div class="section">
                    <table class="vmtable">
                        <tr>
                            <td><strong>Firma</strong></td><td class="uline"> {{ $costumer->name }} </td>
                        </tr>
                        <tr>
                            <td><strong>Firmenbuchnr. / UID</strong></td><td class="uline"> {{ $costumer->uid }} </td>
                        </tr>
                        <tr>
